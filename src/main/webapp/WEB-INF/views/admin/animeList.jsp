                            ...
                            <div class="x_content">
                                ...
                                <div class=" col-sm-1 col-sm-1 col-xs-12">
                                    <a class="btn btn-round btn-success"
                                       href="${pageContext.request.contextPath}/admin/anime/regist/"
                                    ...
                                    <div class="col-md-11">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
                                            ...
                                            <select class="form-control has-feedback-left" id="type" style="-webkit-appearance: none; padding-left: 45px;">
                                                ...
                                                <option value="1">SERIALIZATION</option>
                                ...
                                <div class="table-responsive">
                                    <table id="animeListTable" class="table table-striped jambo_table bulk_action">
                                        <thead>
                                        <tr class="headings">
...
<div id="animeLoading" style="display: none" class="loading">
    <div class="loading-text">Processing...</div>
</div>
<div class="modal fade delete-anime-modal" tabindex="-1" role="dialog" aria-hidden="true">
...
<script>
    ...
    var datatable = $('#animeListTable').DataTable({
        dom:'lrtip',
        processing: true,
        serverSide: true,
        ajax: {
        ...
        columns: [
            {
                ...
                render: function (data, type, full, meta) {
                    if(full.type==1){
                        return '<button type="button" class="btn btn-primary" style="width: 80px;">SERIALIZATION</button>';
                    }
                    if(full.type==2){
                        return '<button type="button" class="btn btn-danger" style="width: 80px;">END</button>';
                    }
                    if(full.type==0){
    ...
    function gotoDelete(id) {
        currDeleteAnimeId = id;
        $('.delete-anime-modal').modal("show");
    }

    function gotoUpdate(id) {
        $('#animeLoading').show();
        window.location.href = '${pageContext.request.contextPath}/admin/anime/edit/' + id + '/';
    }

    function gotoRegist() {
        $('#animeLoading').show();
        window.location.href =  '${pageContext.request.contextPath}/admin/anime/regist/';
    }

    function confirmDeleteClick() {
        $('.delete-anime-modal').modal("hide");
        $('#animeLoading').show();
        var form = $("<form></form>");
        form.attr('action', '${pageContext.request.contextPath}/admin/anime/delete/');
        form.attr('method', 'post');
        var input1 = $("<input type='hidden' name='id'/>");
        input1.attr('value', currDeleteAnimeId);
        form.append(input1);
        form.appendTo("body");
