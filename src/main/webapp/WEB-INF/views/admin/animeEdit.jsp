                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form id="userForm" modelAttribute="animeForm"  enctype="multipart/form-data"
                                    ...
                                    <div>
                                        ...
                                        <div class="col-md-1 col-sm-6 col-xs-12">
                                            <form:select path="type" required="required" data-validate-minmax="10,100"
                                                ...
                                                <c:if test="${animeForm.type ==1}">
                                                    <form:option value="1">SERIALIZATION</form:option>
                                                    <form:option value="2">END</form:option>
                                                </c:if>
                                                <c:if test="${animeForm.type ==2}">
                                                    <form:option value="1">SERIALIZATION</form:option>
                                                    <form:option value="2">END</form:option>
                                                </c:if>
                                                <c:if test="${animeForm.type ==3}">
                                                    <form:option value="1">SERIALIZATION</form:option>
                                                    <form:option value="2">END</form:option>
                                                </c:if>
                                            </form:select>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <form:input path="detail" id="detail"  required="" name="detail" type="hidden"
                                                     ...
                                                     value="${animeForm.detail}"></form:input>
                                        <div class="x_content">
                                            <div id="alerts"></div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <a class="btn btn-primary" href="/admin/anime/list/" style="width: 100px;">キャンセル</a>
                                    <form:input type="hidden" path="id" value="${animeForm.id}"/>
                                    <form:input type="hidden" path="picUrl1" value="${animeForm.picUrl1}"/>
                                    <form:input type="hidden" path="picUrl2" value="${animeForm.picUrl2}"/>
...
<script>
    ...
    $('#picFile1').fileinput({
        ...
        <c:if test="${animeForm.picUrl1 != null && animeForm.picUrl1 != ''}">
        , 'uploadUrl': null, 'initialPreview': [
            <c:forEach items="${animeForm.picUrl1}" var="url1">
    ...
    $('#picFile2').fileinput({
        'language':'ja', 'showClose': true, 'showCaption':false,'showRemove':false,'dropZoneTitle':'', 'showUpload': false, 'previewFileType': 'any', 'autoReplace': true,"minImageWidth":500,"maxImageWidth":500,"minImageHeight":500,"maxImageHeight":500
        <c:if test="${animeForm.picUrl2 != null && animeForm.picUrl2 != ''}">
        , 'uploadUrl': null, 'initialPreview': [
            <c:forEach items="${animeForm.picUrl2}" var="url2">
