...
public class WidgetService {
    ...
    public String getAnimeType(int animeTypeNum) {
        String category = "";
        if (animeTypeNum == Constant.ANIME_TYPE.UNKNOW) {
            category = "不明";
        } else if (animeTypeNum == Constant.ANIME_TYPE.SERIALIZATION) {
            category = "SERIALIZATION";
        } else if (animeTypeNum == Constant.ANIME_TYPE.END) {
            category = "END";
        }
        return category;
    }
    ...
    public String getAnimeColor(int animeTypeNum) {
        String color = "";
        if (animeTypeNum == Constant.ANIME_TYPE.SERIALIZATION) {
            color = "background-color:red";
        } else {
            color = "background-color:#004984";
        }
    ...
    public String getAnimeDetailColor(int animeTypeNum) {
        String color = "";
        if (animeTypeNum == Constant.ANIME_TYPE.SERIALIZATION) {
            color = "color:red";
        } else {
